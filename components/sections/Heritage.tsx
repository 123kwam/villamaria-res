    ...
    <section id="heritage" className="relative">
      <FlowArt aria-label={p.title}>
        ...
        >
          ...
          <h2 className="display-xl font-display whitespace-pre-line">{p.title}</h2>
          <hr className="my-[2vw] border-none border-t border-cream/30" />
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-end">
            ...
            <blockquote className="font-display italic text-gold/90 text-[clamp(1.5rem,2.6vw,2.2rem)] leading-snug max-w-[40ch] md:text-right">
        ...
        >
          ...
          <h3
            className="display-xl font-display whitespace-pre-line italic"
          ...
          <hr className="my-[2vw] border-none border-t" style={{ borderColor: 'rgba(26,17,16,0.18)' }} />
          <p
            className="max-w-[60ch] text-[clamp(1rem,1.8vw,1.5rem)] leading-relaxed font-light italic font-display"
        ...
        >
          ...
          <h3 className="display-xl font-display whitespace-pre-line">{p.panels.fire.h}</h3>
          <hr className="my-[2vw] border-none border-t border-cream/40" />
        ...
        >
          ...
          <hr className="my-[2vw] border-none border-t border-gold/35" />
          <h3 className="display-xl font-display whitespace-pre-line italic">{p.panels.room.h}</h3>
          <hr className="my-[2vw] border-none border-t border-gold/35" />
          <p className="max-w-[55ch] text-[clamp(1rem,1.8vw,1.5rem)] leading-relaxed font-light text-cream/85">
            {p.panels.room.body}
          </p>
          <hr className="my-[2vw] border-none border-t border-gold/35" />
          <p className="mt-auto ml-auto max-w-[40ch] text-right font-display italic text-[clamp(1.25rem,2.5vw,2.2rem)] leading-snug text-gold/90">
        ...
        >
          ...
          <h3 className="display-xl font-display whitespace-pre-line">{p.panels.invite.h}</h3>
          <hr className="my-[2vw] border-none border-t border-gold/40" />
          <div className="grid md:grid-cols-2 gap-10 items-end">
